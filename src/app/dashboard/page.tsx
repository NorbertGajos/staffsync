      ...
      <div style={{ padding:'32px 24px', maxWidth:'900px', margin:'0 auto' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(200px, 1fr))', gap:'16px' }}>
          {[
            ...
            { icon:'📚', title:'Szkolenia', desc:'Materiały szkoleniowe', href:'/documents', roles:['pracownik','koordynator','administrator'] },
{ icon:'📤', title:'Dodaj szkolenie', desc:'Wgraj materiały szkoleniowe', href:'/admin/documents', roles:['administrator','koordynator'] },
