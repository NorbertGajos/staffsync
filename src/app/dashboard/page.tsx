...
export default function DashboardPage() {
  ...
  if (loading) {
    return (
      <div style={{
        minHeight: '100vh',
        background: 'linear-gradient(180deg, #0a6e8a 0%, #7dd3e8 100%)',
        display: 'flex',
        alignItems: 'center',
  ...
  return (
    <div style={{
      minHeight: '100vh',
      background: 'linear-gradient(180deg, #0a6e8a 0%, #1a9bb8 38%, #7dd3e8 68%, #f5ede0 100%)',
      ...
      <div style={{ padding: '32px 24px', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <h2 style={{ color: '#064d61', margin: '0 0 8px', fontSize: '22px' }}>
          ...
          {[
            ...
            .map((item, i) => (
              ...
              >
                ...
                <div style={{ fontWeight: 700, fontSize: '15px', color: '#064d61', marginBottom: '6px' }}>
                  {item.title}
                </div>
